...
[![PyPI](https://img.shields.io/pypi/v/cognis-honeyurl.svg)](https://pypi.org/project/cognis-honeyurl/)
[![CI](https://github.com/cognis-digital/honeyurl/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/honeyurl/actions)
...
HONEYURL exists for one job — generate canary urls/tokens + a matcher for trip events — and does it without a SaaS bill or heavyweight setup.
...
```bash
honeyurl --version
honeyurl scan .                      # scan the current project
honeyurl scan . --format json
honeyurl scan . --fail-on high       # non-zero exit for CI gates
honeyurl mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **canarytokens**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`honeyurl` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
