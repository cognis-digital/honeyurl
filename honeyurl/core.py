"""HONEYURL core — Generate canary URLs/tokens + a matcher for trip events."""
...
RULES = [
    ("HON-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("HON-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("HON-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
