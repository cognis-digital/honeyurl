...
import argparse, sys
from honeyurl.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="honeyurl", description="HONEYURL — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from honeyurl.mcp_server import serve
        return serve()
    if args.cmd == "scan":
