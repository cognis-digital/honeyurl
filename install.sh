#!/usr/bin/env sh
# Universal installer for honeyurl. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/honeyurl.git"
echo "Installing honeyurl ..."
